...
public class TestJavaFXOffscreenChartFactory {
  ...
  public void init() {
    ...
    assertTrue(factory.getPainterFactory().isOffscreen());
    ...
    assertEquals(factory.getPainterFactory().getOffscreenDimension(), d);
  ...
  public void resize() {
    ...
    assertEquals(newDim, canvas.getDimension());
    ...
    assertEquals(newDim.width, image.getWidth(), delta);
    assertEquals(newDim.height, image.getHeight(), delta);
